...
import { fetchDouYinData } from "@/lib/data";

export default async function Page() {
    const data: any[] = await fetchDouYinData();
    return (
        <div className="bg-white rounded-lg shadow m-4 dark:bg-gray-800">
        <div className="w-full mx-auto max-w-screen-xl p-4 flex items-center justify-between">
            <Link href="https://www.douyin.com/" target="_blank" className="w-3/4 truncate text-center font-bold dark:text-gray-300">
                抖音热搜排行榜
            </Link>
